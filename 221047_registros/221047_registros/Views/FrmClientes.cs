...
namespace _221047_registros.Views
{
    public partial class FrmClientes : Form
    {
        ...
        private void FrmClientes_Load(object sender, EventArgs e)
        {
            ...
            cmb_city.DataSource = city_reference.OpenQuery();
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            if ((txt_name.Text != String.Empty || txt_name.Text != " ") &&
                (msk_cpf.Text.Length == 14) && (txt_income.Text != String.Empty || txt_income.Text != " ") && pic_client.ImageLocation != null)
            {
        ...
        {
            if ((txt_name.Text != String.Empty && txt_name.Text != " ") &&
                (msk_cpf.Text.Length == 14) && (txt_income.Text != String.Empty && txt_income.Text != " "))
            {
                Cliente client = new Cliente()
                {
                    client_id = int.Parse(lbl_id.Text),
